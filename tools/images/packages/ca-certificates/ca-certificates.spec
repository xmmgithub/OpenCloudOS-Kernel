...
%install
install -d %{buildroot}%{_cross_sysconfdir}/pki/tls/certs
install -p -m 0644 %{S:0} %{buildroot}%{_cross_sysconfdir}/pki/tls/certs/ca-bundle.crt

install -d %{buildroot}%{_cross_tmpfilesdir}
install -p -m 0644 %{S:1} %{buildroot}%{_cross_tmpfilesdir}/ca-certificates.conf

%files
%dir %{_cross_sysconfdir}/pki
%dir %{_cross_sysconfdir}/pki/tls
%dir %{_cross_sysconfdir}/pki/tls/certs
%{_cross_sysconfdir}/pki/tls/certs/ca-bundle.crt
